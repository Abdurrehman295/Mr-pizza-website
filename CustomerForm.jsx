      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full mt-4 bg-green-700 hover:bg-green-600 text-white font-black text-lg py-4 rounded-full transition-all duration-200 hover:scale-105 hover:shadow-xl hover:shadow-green-900 flex items-center justify-center gap-3"
          >
